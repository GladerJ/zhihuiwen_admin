...
public interface QuestionnaireMapper {
     ...
     * @return 受影响的行数
     */
    int deleteQuestionnaire(@Param("id") Long id);
     ...
     * @return 问卷实体对象
     */
    Questionnaire selectQuestionnaireByIdAndUserId(@Param("id") Long id);
    ...
    List<Questionnaire> selectQuestionnaireByTitleLike(@Param("categoryId") Long categoryId,
                                                       @Param("title") String title);
